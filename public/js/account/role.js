...
var toCapitalize = function toCapitalize() {
  return this.split(' ').map(function (word) {
    return word[0].toUpperCase() + word.substr(1);
  }).join(' ');
};
var toUpperFirst = function toUpperFirst() {
  return this[0].toUpperCase() + this.substr(1);
};
var t = function t(text) {
  var translated = translations[lang][text] || text;
...
/* harmony import */ var _vi__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vi */ "./resources/js/lang/translations/vi.js");




var en = {};
Object.keys(_vi__WEBPACK_IMPORTED_MODULE_3__["default"]).forEach(function (key) {
  en[key] = key;
});
...
var table = $('#tableRole').DataTable({
  ...
  aaSorting: [],
  language: {
    lengthMenu: (0,_lang__WEBPACK_IMPORTED_MODULE_2__["default"])('Number of records _MENU_'),
    info: (0,_lang__WEBPACK_IMPORTED_MODULE_2__["default"])('Showing _START_ to _END_ of _TOTAL_ entries'),
    paginate: {
      previous: '‹',
      next: '›'
    }
  ...
  columns: [{
    data: 'role',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_2__["default"])('Role')
  }, {
    data: 'description',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_2__["default"])('Description')
  }, {
    data: 'Note',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_2__["default"])('Note')
  }, {
    data: 'time_created',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_2__["default"])('Time Created')
  }, {
    data: 'time_updated',
    defaultContent: '',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_2__["default"])('Time Updated')
  }, {
    data: 'id',
    title: (0,_lang__WEBPACK_IMPORTED_MODULE_2__["default"])('Action'),
    defaultContent: '',
    render: function render(data) {
      return "\n                            <button id=\"del-" + data + "\" class=\"btn btn-danger btn-delete\" style=\"width: 80px\">\n                            " + (0,_lang__WEBPACK_IMPORTED_MODULE_2__["default"])('Delete') + "\n                            </button>\n                            ";
    }
  }]
});
